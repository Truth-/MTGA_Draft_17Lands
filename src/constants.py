...
LIMITED_TYPE_PICKTWO = 7
LIMITED_TYPE_PICKTWO_TRAD = 8
...
LOCAL_DATABASE_LOCALIZATION_COLUMN_FORMAT = "Loc"
...
LOCAL_DATABASE_LOCALIZATION_QUERY = f"""SELECT
                                        ...
                                        FROM {LOCAL_DATABASE_TABLE_LOCALIZATION}_{LOCAL_DATABASE_LOCALIZATION_COLUMN_TEXT} A INNER JOIN(
                                            SELECT 
                                                {LOCAL_DATABASE_LOCALIZATION_COLUMN_ID},
                                                min({LOCAL_DATABASE_LOCALIZATION_COLUMN_FORMAT}) AS MIN_FORMAT 
                                            FROM {LOCAL_DATABASE_TABLE_LOCALIZATION}_{LOCAL_DATABASE_LOCALIZATION_COLUMN_TEXT}
...
LIMITED_TYPE_STRING_TWO_DRAFT = "PickTwoDraft"
LIMITED_TYPE_STRING_TWO_DRAFT_TRAD = "PickTwoTradDraft"
...
LIMITED_TYPE_LIST = [
    ...
    LIMITED_TYPE_STRING_TWO_DRAFT,
    LIMITED_TYPE_STRING_TWO_DRAFT_TRAD]
...
LIMITED_TYPES_DICT = {
    ...
    LIMITED_TYPE_STRING_TWO_DRAFT:LIMITED_TYPE_PICKTWO,
    LIMITED_TYPE_STRING_TWO_DRAFT_TRAD:LIMITED_TYPE_PICKTWO_TRAD,
}
